...
| `get_feedback`            | Fetch and claim any open human feedback requests on a canvas.                                                                                                                                                                                                                                                                                                             |
...
| `list_cards`              | Open board cards on this canvas — work humans have queued for agents.                                                                                                                                                                                                                                                                                                     |
...
| `retry_card`              | Re-queue a failed or cancelled board card: its failure clears and the next sweep re-claims it.                                                                                                                                                                                                                                                                            |
| `retry_feedback`          | Re-deliver a piece of human feedback that failed to reach an agent (server restart, agent disconnect).                                                                                                                                                                                                                                                                    |
| `set_status`              | Broadcast a one-line status of what you are working on right now — everyone viewing the canvas sees it live next to your name.                                                                                                                                                                                                                                            |
| `take_card`               | Claim an open board card so you can work on it: the card moves to "in progress" under your name and the result carries the full brief.                                                                                                                                                                                                                                    |
| `wait_for_events`         | Block until something on this canvas needs you: task feedback, a comment, a stop, an answer to your question, or a new queued card.                                                                                                                                                                                                                                       |
